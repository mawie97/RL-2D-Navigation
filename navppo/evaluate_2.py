...
current_setup = "new_random_bresenham_noise3"

base_dir = os.path.join(current_dir, "runs", current_setup)

csv_log_path = os.path.join(base_dir, "eval", "noise1", "lvl_1_4", "eval_log.csv")
os.makedirs(os.path.dirname(csv_log_path), exist_ok=True)

tensorboard_eval_log_dir = os.path.join(
    base_dir, "eval", "noise1", "lvl_1_4", "tensorboard"
)
...
eval_monitor_path = os.path.join(base_dir, "eval", "noise1", "lvl_1_4", "monitor.csv")
